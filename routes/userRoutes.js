...
const { registerUser, loginUser, myProfile, editProfile, fetchAllUser, fetchUserId, followUser, createPost, findAllPosts, myPosts } = require('../controller/userController')
